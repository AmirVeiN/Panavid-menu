    ...
    return (
        <div className="bg-softGray m-5 w-[220px] h-[778px] rounded-3xl flex flex-col justify-between pb-5 items-center">
            <div className="w-full flex flex-col items-center ">
                ...
                <button className="bg-gray2 mb-4 left-5 rounded-3xl w-[184px] h-[38px] flex flex-row justify-evenly items-center">
                    <p className="text-white">Add Video Player</p>
                    <FaCirclePlus size="24px" color="#FF4667" />
                </button>
            ...
            <button className="flex flex-row h-[38px] w-[184px] bg-gradient-to-b from-top to-down justify-evenly items-center rounded-3xl">
                <FaWordpress size="28px" color="white" />
                <p className="text-white font-light">Back To Wordpress</p>
            </button>
        </div>
